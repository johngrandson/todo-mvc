...
impl Component for App {
    ...
    fn create(_ctx: &Context<Self>) -> Self {
        ...
        let state = State {
            entries,
            active_filter: state::ActiveFilter::Active,
            filter: Filter::All,
            edit_value: "".into(),
        };
            ...
            <div class="todomvc-wrapper">
                <section class="todoapp">
                    ...
                    <footer class={classes!("footer", hidden_class)}>
                        ...
                        <span class="todo-count ml-2">
                            <strong>{ self.state.active_filters() }</strong>
                            { " filtered item(s) active" }
                        </span>
                        <ul class="filters">
